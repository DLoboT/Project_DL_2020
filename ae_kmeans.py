...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep 11 17:55:46 2020
...
from utils import  split_train_val, target_distribution, split_test, ratio_per_class  
from utils import mapping_labels, check_overwriting_models, write_metrics_k_means
...
#%% Step 3: Deep Embedding Clustering (DEC)
        if args.DEC:
